...
public class Activity3_2 {
    ...
    public void imageScrollTest() {
        ...
        List numberOfImages = (List) driver.findElementsByXPath("//android.view.View/android.view.View/android.widget.Image");
        StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("Number of image shown currently: ");
		System.out.println(stringBuilder.toString());
        
        // Assertion before scrolling
        AssertJUnit.assertEquals(numberOfImages.size(), 4);
        ...
        numberOfImages = (List) driver.findElementsByXPath("//android.view.View/android.view.View/android.widget.Image");
        StringBuilder stringBuilder2 = new StringBuilder();
		stringBuilder2.append("Number of image shown currently: ");
		StringBuilder append = stringBuilder2.append(numberOfImages.size());
